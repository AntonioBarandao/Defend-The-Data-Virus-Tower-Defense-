...
func show_defeat() -> void:
	...
	_animated_display.animation = DEFEAT_ANIMATION
	...
	_reset_button(_quit_game_button)
...
func _disable_actions() -> void:
	...
	_quit_game_button.disabled = true
